        ...
        <div class="x_panel shadow">
          <div class="x_content">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="tanggal" name="tanggal" readonly="readonly" value="<?= $tanggal ;?>">
            </div>
            <div class="form-group">
              <label for="tanggalKembali">Tanggal Kembali</label>
              <input type="text" class="form-control" id="tanggalKembali" name="tanggalKembali" readonly="readonly" value="<?= $tanggalKembali ;?>">
            </div>
          </div>
        </div>
        ...
        <div class="x_panel shadow">
          ...
          <div class="x_content">
            ...
            <div class="input-group mb-3">
              <input type="text" class="form-control nama_anggota <?= (form_error('anggota')) ? 'is-invalid' : '' ?>" readonly="readonly" name="nama_anggota">
      ...
      <div class="col-md-6">
        ...
        <div class="x_panel shadow">
          ...
          <div class="x_content">
            <?= form_error('judul') ;?>
            <div class="input-group mb-3">
              <input type="text" class="form-control <?= (form_error('judul')) ? 'is-invalid' : '' ?>" readonly="readonly" id="judul" name="judul">
              <div class="input-group-append">
                <button class="btn btn-secondary" type="button" id="cari-buku" data-toggle="modal" data-target="#modalBuku">Cari</button><br>
              </div>              
            </div>
            <div class="input-group mb-3">
          ...
          <table class="table table-striped jambo_table bulk_action">
            ...
            <tbody>
              ...
              <tr class="even pointer">
                ...
                <td class=" last">
                  <button class="btn btn-sm btn-primary pilih-anggota" type="button">Pilih</button>
                </td>
              </tr>
              <?php endforeach ?> 
            </tbody>
              ...
              <table class="table table-striped jambo_table bulk_action">
                ...
                <tbody>
                  ...
                  foreach ($buku as $row): 
                    if($row->stok > 0) :  ?>
                  <tr class="even pointer">
                    <td class="d-none"><?= $row->id_buku;?></td>
                    <td class=" "><?= $i++ ;?> </td>
                    ...
                    <td class=" last">
                      <button class="btn btn-sm btn-primary pilih-buku" type="button">Pilih</button>
                    </td>
                  </tr>
                  <?php endif;
                        endforeach ?> 
