  ...
  <div class="">
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12  ">
        <div class="x_panel">
          <div class="x_title">
            <a href="<?= base_url() ;?>Laporan_peminjaman/export" class="btn btn-sm btn-success">Export ke Excel</a>
            <a href="<?= base_url() ;?>Laporan_peminjaman/pdf" class="btn btn-sm btn-danger">Export ke Pdf</a>
            <div class="clearfix"></div>
          </div>
          <div class="x_content">
            <h3 align="center">Data Peminjaman</h3><br>
